    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-rose-50">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img src="/images/p-5.png" alt="Pricing Background" className="w-full h-full object-cover opacity-20" />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-tight mb-6">
              Simple, Transparent Pricing
               ...
               Choose the perfect plan for your property search. From one-time visits to extended packages with multiple house visits.
             </p>
          </div>
        </div>
      </section>
                     ...
                     <div className="mb-6">
                       <div className="relative">
                         ...
                         <div className="flex items-baseline justify-center gap-2">
                           <span className="text-6xl font-black bg-gradient-to-r from-indigo-600 to-fuchsia-600 bg-clip-text text-transparent">₹99</span>
